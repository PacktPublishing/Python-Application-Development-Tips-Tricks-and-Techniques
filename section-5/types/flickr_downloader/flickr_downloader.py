...
class FlickrDownloader:
    def __init__(self, api_key: str, download_location: str) -> None:
    ...
    def get_photo_list(self) -> Dict[str, object]:
    ...
    @staticmethod
    def download_photo(photo: Dict[str, object]) -> bytes:
        try:
    ...
    @staticmethod
    def __save_photo(filename: str, photo_content: bytes):
        try:
